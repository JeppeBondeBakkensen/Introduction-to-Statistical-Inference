...
\NormalTok{  g1 }\OtherTok{\textless{}{-}}\NormalTok{ n}\SpecialCharTok{*}\FunctionTok{log}\NormalTok{(param[}\DecValTok{2}\NormalTok{]) }\SpecialCharTok{{-}}\NormalTok{ n}\SpecialCharTok{*}\FunctionTok{digamma}\NormalTok{(param[}\DecValTok{1}\NormalTok{]) }\SpecialCharTok{+} \FunctionTok{sum}\NormalTok{(}\FunctionTok{log}\NormalTok{(data))}
...
\NormalTok{  h1 }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\NormalTok{n}\SpecialCharTok{*}\FunctionTok{trigamma}\NormalTok{(param[}\DecValTok{1}\NormalTok{])}
...
\includegraphics{17-LikelihoodInference_files/figure-latex/unnamed-chunk-4-1.pdf}

\hypertarget{bootstrap}{%
\chapter{Bootstrap}\label{bootstrap}}

\hypertarget{intro-to-the-bootstrap}{%
\section{Intro to the bootstrap}\label{intro-to-the-bootstrap}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qt}\NormalTok{(}\FloatTok{0.025}\NormalTok{,}\DecValTok{9}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{quantile}\NormalTok{(}\FunctionTok{rt}\NormalTok{(}\DecValTok{100000}\NormalTok{,}\DecValTok{9}\NormalTok{), }\FloatTok{0.975}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{18-Bootstrap_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\section{Bootstrapping linear models}\label{bootstrapping-linear-models}}
...
All Bayesian inference (and prediction) is based on the \emph{posterior distribution} \(\Pi_n(\theta)\), which is the conditional distribution of the parameter \(\theta\) given the observed data, and is derived using Bayes' Rule:
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(SASmixed)}
\NormalTok{y }\OtherTok{\textless{}{-}}\NormalTok{ (Multilocation}\SpecialCharTok{$}\NormalTok{Fe}\SpecialCharTok{\^{}}\NormalTok{\{}\SpecialCharTok{{-}}\DecValTok{1}\SpecialCharTok{/}\DecValTok{2}\NormalTok{\}}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)}\SpecialCharTok{/}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}
\FunctionTok{hist}\NormalTok{(y)}
\end{Highlighting}
\end{Shaded}

\includegraphics{19-BayesianStatistics_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dnormx1 }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{dnorm}\NormalTok{(x, }\FloatTok{1.279}\NormalTok{,}\FunctionTok{sqrt}\NormalTok{(}\FloatTok{0.05}\SpecialCharTok{*}\FloatTok{0.05}\SpecialCharTok{/}\DecValTok{109}\NormalTok{))}
\NormalTok{dnormx2 }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{dnorm}\NormalTok{(x, }\FloatTok{1.277}\NormalTok{,}\FunctionTok{sqrt}\NormalTok{(}\FloatTok{0.05}\SpecialCharTok{*}\FloatTok{0.05}\SpecialCharTok{/}\DecValTok{108}\NormalTok{))}

\FunctionTok{curve}\NormalTok{(dnormx1, }\FloatTok{1.25}\NormalTok{,}\FloatTok{1.3}\NormalTok{, }\AttributeTok{col =} \StringTok{\textquotesingle{}red\textquotesingle{}}\NormalTok{)}
\FunctionTok{curve}\NormalTok{(dnormx2, }\FloatTok{1.25}\NormalTok{,}\FloatTok{1.3}\NormalTok{, }\AttributeTok{col =} \StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, }\AttributeTok{add =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{19-BayesianStatistics_files/figure-latex/unnamed-chunk-2-1.pdf}
